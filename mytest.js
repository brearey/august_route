    ...
    const messages = [
      {
        "role": "system",
        "content": `
          Вот список названий и времен мероприятий ежегодного августовского совещания работников образования с общей темой “Развитие единой системы образования”:
      ...
      {
        "role": "user",
        "content": `Если я директор школы - какие мероприятия мне посетить? Напиши только номера мероприятий через запятую, которые лучше подходят мне. Учитывай время мероприятия. Например если в 09.00-10.00 мероприятие 1, а в 09.00-10.00 мероприятие 2, то я смогу посетить только одно.`
      }
    ]
